    ...
    return (
          <form>
              <div className="form-fields">
                ...
                <label htmlFor="field2" className="field-label">Do:</label>
                <input id="field2" className="field-input" type="text" />
                
                <label htmlFor="select1" className="field-label">Počet osob:</label>
                ...
                <label htmlFor="select2" className="field-label">Stravování:</label>
                <select id="select" className="field-input">
                ...
                <label htmlFor="field4" className="field-label">email:</label>
                <input id="field1" className="field-input" type="text" />

                <label htmlFor="field5" className="field-label">Telefon:</label>
                <input id="field1" className="field-input" type="text" />
